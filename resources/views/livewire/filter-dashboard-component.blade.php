<div>
<div class="px-4 py-4 border-gray-100 border  bg-gray-50">
    <a class=" text-base mb-1 font-semibold">Filter</a>
    <div class="flex gap-4 mt-2">
        <div class="sm:w-36 w-full relative flex  flex-col  text-neutral-600 dark:text-neutral-300">
            ...
            <select wire:ignore id='date-dropdown' wire:model.live="yearAlert" class=" w-full appearance-none text-black  border border-neutral-300 bg-white px-4 py-2 text-sm focus:outline-none">
