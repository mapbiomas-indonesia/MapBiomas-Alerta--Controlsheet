<div class="py-6 px-4 border border-gray-100 z-20 relative  bg-gray-50 mt-4  dark:bg-slate-800 dark:border-slate-800 dark:text-slate-400">
    <div class="text-base mb-1 font-semibold ">
        <a class="">Alert status by region</a>
    </div>

    <div class="overflow-y-auto w-full">
        <table class="w-full border-collapse border-b border-gray-300">
          <thead class="text-xs font-semibold">
            <tr class="bg-gray-50 dark:bg-slate-700 text-left">
              <th class="border-b border-gray-300 dark:border-slate-700 px-4 py-2">Status</th>
              <th class="border-b border-gray-300 dark:border-slate-700 px-4 py-2">Bali & Nusa Tenggara</th>
              <th class="border-b border-gray-300 dark:border-slate-700 px-4 py-2">Java</th>
              <th class="border-b border-gray-300 dark:border-slate-700 px-4 py-2">Kalimantan</th>
              <th class="border-b border-gray-300 dark:border-slate-700 px-4 py-2">Maluku</th>
              <th class="border-b border-gray-300 dark:border-slate-700 px-4 py-2">Papua</th>
              <th class="border-b border-gray-300 dark:border-slate-700 px-4 py-2">Sulawesi</th>
              <th class="border-b border-gray-300 dark:border-slate-700 px-4 py-2">Sumatra</th>
              <th class="border-b border-gray-300 dark:border-slate-700 px-4 py-2">TOTAL</th>
            </tr>
          </thead>
          <tbody class="text-xs">
