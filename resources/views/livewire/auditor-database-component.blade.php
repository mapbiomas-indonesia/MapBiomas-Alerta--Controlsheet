<div class="mt-6 z-20 relative ">
    <h1 class="text-3xl font-semibold dark:text-slate-400">Alerts</h1>
    <div class="flex gap-4 sm:flex-row flex-col mt-4 items-end justify-between">
        <div class="flex gap-4">
        <input class=" sm:w-52 w-full py-2 border-gray-500 border px-2 focus:outline-none dark:bg-slate-700 dark:border-slate-600 dark:text-slate-300" wire:model.live='searchId' placeholder="alert ID">
        <div class="flex flex-col">
            ...
            <div class="sm:w-40 w-full relative flex  flex-col  text-neutral-600 dark:text-neutral-300">
                ...
                <select wire:ignore wire:model.live='selectStatus'class="dark:bg-slate-700 dark:border-slate-600 dark:text-slate-300 w-full appearance-none text-black  border border-neutral-300 bg-gray-100 px-4 py-2 text-xs focus:outline-none">
        ...
        <div class="flex flex-col">
            ...
            <div class="sm:w-36 w-full relative flex  flex-col  text-neutral-600 dark:text-neutral-300">
                ...
                <select wire:ignore id='date-dropdown' wire:model.live="yearAlert" class="dark:bg-slate-700 dark:border-slate-600 dark:text-slate-300 w-full appearance-none text-black  border border-neutral-300 bg-gray-100 px-4 py-2 text-xs focus:outline-none">
                    <option value="all">all</option>
                </select>
            </div>
